...
<?= $this->section('title') ?>Grafo Global de Leads<?= $this->endSection() ?>
...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
    <div>
        <h1 class="mb-1"><i class="bi bi-diagram-2 me-2"></i>Grafo Global de Propagação</h1>
        <p class="text-muted-custom mb-0">Visualização de redes de propagação de todas as campanhas ativas</p>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        initGraph('graphContainer', '/admin/api/propagators/graph');
    });
</script>
<?= $this->endSection() ?>
